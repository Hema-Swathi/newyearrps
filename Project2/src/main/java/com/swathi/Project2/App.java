...
public class App 
{
	...
	public static void main( String[] args )
    {
        ...
        System.out.println("sum obtained is:"+totweight);
        newyear.sortChocolates("cost");  //sorting chocolates by weights
        System.out.println("after sorting the chocolates");
        ...
        System.out.println(" please enter lower limit (available costs of candies here: 5,10,15)");
        lowlimit=in.nextInt();
        System.out.println(" please enter  high limit (available costs of candies here: 5,10,15)");
